    ...
    <header class="bg-white ">
      <nav class="bg-white ">
        <div class="container flex flex-col items-center p-6 mx-auto">
          ...
          <div class="flex items-center justify-center mt-6 text-gray-600 capitalize ">
            <a href="#" class="mx-2 text-gray-800 border-b-2 border-blue-500  sm:mx-6">
              home
            </a>

            <a href="#" class="mx-2 border-b-2 border-transparent hover:text-gray-800  hover:border-blue-500 sm:mx-6">
              features
            </a>
      ...
      <div class="container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div class="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
          ...
          <div class="max-w-lg lg:mx-12 lg:order-2">
            <h1 class="text-3xl font-semibold tracking-wide text-gray-800  lg:text-4xl">The best Apple Watch apps</h1>
...
export default HeroWithHeader6;
