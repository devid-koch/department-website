...
const Footer2 = () => {
  return (
    <div class={`pt-16 ${defaultPadding} `}>
        ...
        <div class="space-y-2 text-sm">
          ...
          <div class="flex">
            ...
            <a
              ...
              title="Our phone"
              class="transition-colors duration-300 text-purple-400 hover:text-purple-800"
            >
              850-123-5021
            </a>
          </div>
      ...
      <div class="flex flex-col-reverse justify-between pt-5 pb-10 lg:flex-row">
        ...
        <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a href="/" class="text-sm text-gray-600 transition-colors duration-300 hover:text-purple-400">
              F.A.Q
            </a>
          </li>
          <li>
