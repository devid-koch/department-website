const Contact9 = () => {
  return (
    <section class="min-h-screen bg-white  lg:flex">
      <div class="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg: lg:px-12 xl:px-32 lg:w-1/2">
        <h1 class="text-2xl font-semibold text-gray-800 capitalize  lg:text-3xl">hire us.</h1>

        <p class="mt-4 text-gray-500 ">Ask us everything and we would love to hear from you</p>

        <div class="mt-6 md:mt-8">
          <h3 class="font-medium text-gray-600  ">Follow us</h3>
      ...
      <div class="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24 ">
        <form>
          ...
          <div class="w-full mt-4">
            ...
            <textarea
              class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-56     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
              placeholder="Message"
            ></textarea>
          </div>
