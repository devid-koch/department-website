      ...
      <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2 xl:grid-cols-3">
          <div>
            ...
            <h1 class="mt-6 text-xl font-semibold text-gray-800 ">What do you want to know about UI</h1>
            ...
            <a href="#" class="inline-block mt-4 text-blue-500 underline hover:text-blue-400">
              Read more
            </a>
          </div>
          ...
          <div>
            ...
            <h1 class="mt-6 text-xl font-semibold text-gray-800 ">All the features you want to know</h1>
