      ...
      <div class="grid gap-5 row-gap-8 lg:grid-cols-2">
        <div class="flex flex-col justify-center">
          <div class="max-w-xl mb-6">
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              ...
              <span class="relative px-1">
                <div class="absolute inset-x-0 bottom-0 h-3 transform -skew-x-12 bg-teal-400"></div>
                <span class="relative inline-block text-purple-400">a lazy dog</span>
              </span>
            </h2>
          ...
          <div class="grid gap-5 row-gap-8 sm:grid-cols-2">
            <div class="bg-themeWhite border-l-4 shadow-sm border-purple-400">
              <div class="h-full p-5 border border-l-0 rounded-r">
                <h6 class="mb-2 font-semibold leading-5">I'll be sure to note that in my log</h6>
            ...
            <div class="bg-themeWhite border-l-4 shadow-sm border-purple-400">
              <div class="h-full p-5 border border-l-0 rounded-r">
                <h6 class="mb-2 font-semibold leading-5">A business big enough that it could be listed</h6>
                <p class="text-sm text-gray-900">
