      ...
      <div class="container px-6 py-8 mx-auto">
        <div class="xl:items-center xl:-mx-8 xl:flex">
          <div class="flex flex-col items-center xl:items-start xl:mx-8">
            ...
            <p class="mt-4 font-medium text-gray-500 ">You can get All Access by selecting your plan!</p>

            <a
              href="#"
              class="flex items-center mt-4 -mx-1 text-sm text-gray-700 capitalize  hover:underline hover:text-blue-600 "
            >
