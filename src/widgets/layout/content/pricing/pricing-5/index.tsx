  ...
  return (
    <section class="bg-white ">
      <div class="container px-6 py-8 mx-auto">
        <div class="max-w-2xl p-1.5 mx-auto overflow-hidden bg-gray-100 rounded-lg ">
          <div class="grid gap-3 md:grid-cols-3">
            <button class="px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-transparent rounded-lg focus:outline-none   hover:bg-gray-200">
              Monthly
            </button>

            <button class="flex items-center justify-center px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-gray-200 rounded-lg  focus:outline-none ">
              <span class="mx-1">Biannually</span>
              <span class="text-xs mx-1 font-normal text-white bg-blue-500 rounded-full py-0.5 px-1.5">save 10%</span>
            </button>

            <button class="flex items-center justify-center px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-transparent rounded-lg focus:outline-none   hover:bg-gray-200">
        ...
        <div class="flex flex-col items-center justify-center mt-16 space-y-6 md:items-end md:-mx-5 md:space-y-0 md:flex-row">
          <div class="w-full px-6 py-4 transition-colors duration-300 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 ">
            <div class="text-center">
              <p class="text-2xl font-semibold text-gray-800 ">Basic</p>
              <p class="mt-4 text-gray-500 ">Essentail Features</p>
              <h4 class="mt-2 text-gray-600 line-through ">$59.99</h4>
              <h4 class="mt-2 text-4xl font-semibold text-gray-800 ">$53.99</h4>
          ...
          <div class="w-full overflow-hidden transition-colors duration-300 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 ">
            <p class="py-2 text-sm text-center text-white uppercase bg-blue-500">Recommended by experts</p>
            <div class="px-6 py-4">
              <div class="text-center">
                <p class="text-2xl font-semibold text-gray-800 ">Pro</p>
                <p class="mt-4 text-gray-500 ">Advanced Features</p>
                <h4 class="mt-2 text-gray-600 line-through ">$89.99</h4>
