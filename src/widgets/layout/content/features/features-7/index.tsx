    ...
    <section class="bg-white ">
      <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl ">
          explore our <br></br> awesome <span class="underline decoration-blue-500">Components</span>
        </h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div class="space-y-3">
            ...
            <h1 class="text-xl font-semibold text-gray-700 capitalize ">New Components Every month</h1>
          ...
          <div class="space-y-3">
            ...
            <h1 class="text-xl font-semibold text-gray-700 capitalize ">Easy to customiztions</h1>
