      ...
      <div class="flex items-start justify-between">
        <div class="relative hidden h-screen shadow-lg lg:block w-80">
          <div class="h-full bg-white ">
            <div class="flex items-center justify-start pt-6 ml-8">
              <p class="text-xl font-bold ">Plannifer</p>
            </div>
            <nav class="mt-6">
              <div>
                <a
                  class="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-purple-500 "
                  href="#"
                >
        ...
        <div class="flex flex-col w-full md:space-y-4">
          <header class="z-40 flex items-center justify-between w-full h-16">
            ...
            <div class="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
              <div class="relative flex items-center justify-end w-full p-1 space-x-4">
                ...
                <span class="w-1 h-8 bg-gray-200 rounded-lg"></span>
                <a href="#" class="relative block">
                  <img alt="profil" src="/images/person/1.jpg" class="mx-auto object-cover rounded-full h-10 w-10 " />
                </a>
                <button class="flex items-center text-gray-500  text-md">
                  Charlie R
                  <svg
                    width="20"
                    height="20"
          ...
          <div class="h-screen px-4 pb-24 overflow-auto md:px-6">
            <h1 class="text-4xl font-semibold text-gray-800 ">Good afternoom, Charlie</h1>
            <h2 class="text-gray-400 text-md">Here&#x27;s what&#x27;s happening with your ambassador account today.</h2>
            <div class="flex flex-col items-center w-full my-6 space-y-4 md:space-x-4 md:space-y-0 md:flex-row">
                ...
                <div class="relative w-full overflow-hidden bg-white shadow-lg ">
                  <a href="#" class="block w-full h-full">
                    ...
                    <div class="w-full h-3 bg-gray-100">
                      <div class="w-2/5 h-full text-xs text-center text-white bg-green-400"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="flex items-center w-full space-x-4 md:w-1/2">
                ...
                <div class="w-1/2">
                  <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                    <p class="text-2xl font-bold text-black ">$93.76</p>
                    <p class="text-sm text-gray-400">Commission in approval</p>
            ...
            <div class="grid grid-cols-1 gap-4 my-4 md:grid-cols-2 lg:grid-cols-3">
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">Project Reffered</p>
              ...
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">Project Paid</p>
                  <div class="flex items-end my-6 space-x-2">
                    <p class="text-5xl font-bold text-black ">23</p>
                    <span class="flex items-center text-xl font-bold text-green-500">
                      <svg
                        width="20"
                        fill="currentColor"
                      ...
                      <div class="flex items-end text-xs">
                        ...
                        <span class="flex items-center">
                          <svg
                            ...
                            fill="currentColor"
                            height="20"
                            class="h-3 text-red-500 transform rotate-180"
                            viewBox="0 0 1792 1792"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <path d="M1675 971q0 51-37 90l-75 75q-38 38-91 38-54 0-90-38l-294-293v704q0 52-37.5 84.5t-90.5 32.5h-128q-53 0-90.5-32.5t-37.5-84.5v-704l-294 293q-36 38-90 38t-90-38l-75-75q-38-38-38-90 0-53 38-91l651-651q35-37 90-37 54 0 91 37l651 651q37 39 37 91z"></path>
              ...
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">New features</p>
                  <div class="flex items-end my-6 space-x-2">
                    <p class="text-5xl font-bold text-black ">12</p>
              ...
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">Sign in</p>
                  <div class="flex items-end my-6 space-x-2">
                    <p class="text-5xl font-bold text-black ">16</p>
                    <span class="flex items-center text-xl font-bold text-red-500">
                      <svg
                        width="20"
                        fill="currentColor"
              ...
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">Sales</p>
                  <div class="flex items-end my-6 space-x-2">
              ...
              <div class="w-full">
                <div class="relative w-full px-4 py-6 bg-white shadow-lg ">
                  <p class="text-sm font-semibold text-gray-700 border-b border-gray-200 w-max ">Maintenance</p>
                  <div class="flex items-end my-6 space-x-2">
                    <p class="text-5xl font-bold text-black ">15</p>
                    <span class="flex items-center text-xl font-bold text-green-500">
                      <svg
                        width="20"
                        fill="currentColor"
